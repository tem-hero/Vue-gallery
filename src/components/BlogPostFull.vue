...
.blog__single-post__back-button {
    position: absolute;
    left: 0;
    top: 20px;
    font-size: 32px;
...
.blog__single-post__subtitle {
    font-size: inherit;
    margin: 20px 0;
}

.blog__single-post__date {
...
.blog__single-post__backdrop {
    background-color: rgba(250, 250, 250, 0.99);
}

.comment__form__top-field {
    display: block;
    width: 32%;
}
</style>